<?php
function mclist_func( $atts = array(), $content="null" ) {
    ...
    $mcRowStart = '<div id="mclist-'.$mcRand.'" class="row mclist '.$mcov.' '.$colorscheme.' '.$rowclass.' '.$listtype.'"><div class="wrapper '.$mw.'">';
    $mcRowEnd = '</div></div>';
    ...
    <script>
        window.addEventListener("load", function(){
            ...
            function fireAllTorpedos(mcCatName, mcNumOf, mcTagName) {
                ...
                // console.log('cat:' + mcCatName);
                // console.log('tag_name:' + mcTagName);
            ...
            <?php }else if($loadmoreonclick || $loadmoreonscroll){ ?>
                ...
                document.querySelector("#loadmore-<?php echo $mcRand; ?>").addEventListener('click', function(){
                        page++;
                        fireAllTorpedos(mcCatName, mcNumOf, mcTagName);
                }, false);
...
add_shortcode( 'mclist', 'mclist_func' );
?>