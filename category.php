    ...
    <div class="main-wrap">
        <main class="site-main" role="main">
            ...
            <section class="archive-content">
                <?php echo do_shortcode('[instalist category_name='.$cat_slug.' numofmobile="24" numofdesktop="32" gridclass="sm-1 lg2-2 lg3-4" loadmoreonscroll="true" noheader=true noviewall=true]'); ?>
            </section>
